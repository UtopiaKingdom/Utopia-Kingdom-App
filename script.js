// Copied from test of site/script.js - background canvas, carousel, and interactions
document.addEventListener('DOMContentLoaded', ()=>{
  ...
  (function initBgVideo(){
    ...
    const localUrl = 'test%20of%20site/assets/black-hole.mp4';
    ...
    const altLocal = 'test%20of%20site/assets/black-hole.mp4';
    function tryUrl(url){
